...
def render_connectivity_section():
    ...
    st.markdown(
        ...
        '<div class="connect-stage"><div class="connect-stage-num">04 · RECONNECT</div><div class="connect-stage-title">Connectivity returns</div><div class="connect-stage-text">The runtime leaves offline mode automatically after the required outage window.</div></div>'
    ...
    st.markdown("### START OFFLINE EXECUTION")
    st.caption("Enter offline execution for a full 60-second outage window. During this period, NEXORA performs local work and persists every event; after the window, synchronization happens automatically.")
...
def render_active_section(result):
    ...
    elif active == "SYSTEM HEALTH":
        render_section_header(
            "SYSTEM HEALTH",
            "Runtime health indicators for AI, execution, deadlock detection and scheduling.",
            "RUNTIME STATUS"
        )
